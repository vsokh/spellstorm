...
export const CLASSES: Record<string, ClassDefInput> = {
  ...
  stormcaller: {
    ...
    spells: [
      ...
      { name: 'Discharge', key: 'RMB', type: SpellType.Nova, dmg: 0, mana: 22, cd: 5, range: 180, color: '#cc88ff', stun: 1.5, channel: 2.5, channelSlow: 0.6, channelBreak: 5, detonateMark: { name: 'static', dmgPerStack: 3.0, effectOnDetonate: { stun: 0.5 } } },
